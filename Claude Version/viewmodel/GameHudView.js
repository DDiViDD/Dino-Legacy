// GameHudView: shadowed-white "objectives" overlay anchored to the top-left
// of the screen, like quest text in many games.
...
GameHudView.prototype._render = function() {
    ...
    this._scoreLine.innerHTML = '<span class="obj-label">Objective:</span> Highscore - ' + s.toLocaleString();
